    ...
    <section className='bg-[#F8F8F9] '>
        <div className='md:flex lg:flex justify-evenly grid justify-items-center'>
                <div className='grid justify-items-center sm:h+5 grid-cols-1 gap-2 content-center'> 
                    ...
                    <button onClick={handleAppointment} className='delay-150 duration-100 transform hover:scale-125 transition ease-linear bg-[#262161] px-6 py-2 m-4 text-[#F7F8F9] rounded-lg'>
                      Agendar cita
                    </button>
                </div>
            <picture className=''>
